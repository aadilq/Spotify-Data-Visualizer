...
const API_KEY = "BQBkS9tooGKCs1UupHNn6VZcur_ei-DAPvjYd-JuZ0W2kPEpdJQ7Itg2ctXJbRlM-m8koahDdWxOUUAwUN54EoA4E6ziFf_5hLy2h4u--OBW_7NZduf24WYrKOkLdL5W_-yrcPpiynQ"
...
async function searchArtists(artist) { //Search for an artist using Spotify's API
    ...
    const cleanedArtistData = retrievedArtists.map(artists => (
        {
            id: artist.id,
            name: artists.name,
